...
def dog_quiz():
    ...
    if dog_year_converter == key_age_dog:
        ...
        abteil_1.inventar.append("Leckerli")
        print(abteil_1.inventar)
        if input("Möchtest du dein Leckerli dem Mops geben? ja(y) oder nein(n)") == "y" :
             abteil_1.inventar.remove("Leckerli")
...
def streak_i():
    print("""Im Zug lässt du dich auf deinem Sitzplatz nieder und schaust dich um.\nDie Sitze sind mit dunkelrotem Samt
    ...
    if action_1.upper() == "Z":
        ...
        abteil_2.assign_inventar(abteil_1.inventar)
        abteil_2.init_streak(1)
...
abteil_1=abteil_constructor.Abteil(1,"rot", {1:"alte Lady",2:"rüstiger Mops"}, 0.0, False,{1:streak_i})