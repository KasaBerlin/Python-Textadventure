...
def dog_quiz():
    ...
    if dog_year_converter == key_age_dog:
        print(
            f"Richtig! Du hast nach {guesses_made} Tipps das Alter erraten!\nDafür erhälst du ein Leckerli in deinem Inventar!"
        )
        ...
        if input("Möchtest du dein Leckerli dem Mops geben? ja(y) oder nein(n)") == "y":
            ...
            print(
                f"Leider nicht richtig geraten. Das Alter des Hundes ist {key_age_dog} Jahre alt in Menschenalter."
            )
...
def streak_i():
    ...
    \nEine nette alte Dame setzt sich mit\nihrem alten röchelden Mops neben dich und lächelt dich an."""
